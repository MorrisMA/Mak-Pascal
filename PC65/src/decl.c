...
void declarations(SYMTAB_NODE_PTR);
void const_definitions(void);
void do_const(SYMTAB_NODE_PTR);
void type_definitions(void);
TYPE_STRUCT_PTR do_type(void);
TYPE_STRUCT_PTR identifier_type(SYMTAB_NODE_PTR);
TYPE_STRUCT_PTR enumeration_type(void);
TYPE_STRUCT_PTR subrange_type(SYMTAB_NODE_PTR);
void get_subrange_limit(SYMTAB_NODE_PTR, int *, TYPE_STRUCT_PTR *);
TYPE_STRUCT_PTR array_type(void);
TYPE_STRUCT_PTR record_type(void);
TYPE_STRUCT_PTR make_string_typep(int);
int array_size(TYPE_STRUCT_PTR);
void var_declarations(SYMTAB_NODE_PTR);
void var_or_field_declarations(SYMTAB_NODE_PTR, TYPE_STRUCT_PTR, int);
...
extern void emit_numeric_equate(SYMTAB_NODE_PTR);
...
TYPE_STRUCT_PTR subrange_type(SYMTAB_NODE_PTR min_idp)
{
    ...
    */
    ...
    tp->size = (max_typep == char_typep) ? sizeof(char) : sizeof(short);
...
void var_or_field_declarations(SYMTAB_NODE_PTR rtn_idp,
    ...
    */
    ...
    while (token == IDENTIFIER) {
        ...
        */
        ...
        synchronize((var_flag) ? follow_variables_list : follow_fields_list,
                    declaration_start_list,
                    statement_start_list                                    );
