...
SYMTAB_NODE_PTR search_symtab_display(char *);
SYMTAB_NODE_PTR enter_symtab(char *, SYMTAB_NODE_PTR *);
void init_symtab(void);
void enter_standard_routine(char *, ROUTINE_KEY, DEFN_KEY);
void enter_scope(SYMTAB_NODE_PTR);
...
void init_symtab(void)
{
    ...
    */
    ...
    integer_typep->size     = sizeof(short);
    ...
    boolean_typep->size     = sizeof(short);
...
void enter_standard_routine(char        *name,
