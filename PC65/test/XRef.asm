...
word_002	EQU	+0	;numeric literal absolute	---word_002	EQU	+0
;   21:                firstnumberindex,    {head and tail of    }
;   22:                lastnumberindex      {  linked number list}
;   23:                    : numbertableindex;
firstnumberindex_003	EQU	+20	;numeric literal absolute	---firstnumberindex_003	EQU	+20
lastnumberindex_004	EQU	+22	;numeric literal absolute	---lastnumberindex_004	EQU	+22
;   24:                END;
;   25: 
;   26:     numberentrytype  = RECORD  {entry in number table}
;   27:                number                   {line number}
;   28:                    : linenumbertype;
number_005	EQU	+0	;numeric literal absolute	---number_005	EQU	+0
;   29:                nextindex                {index of next   }
;   30:                    : numbertableindex;  {  in linked list}
nextindex_006	EQU	+2	;numeric literal absolute	---nextindex_006	EQU	+2
;   31:                END;
;   32: 
...
ch_017	EQU	-6	;base-relative	---ch_017	EQU	<[bp-6]>
...
;   63:         write(linenumber:5, ' : ');
	...
	adj #4	;---	add		sp,4
	psh #S_020	;---	lea		ax,WORD PTR S_020
						;---	push	ax
	psh #0	;---	mov		ax,0
						;---	push	ax
	psh #3	;---	mov		ax,3
...
ch_025	EQU	+6	;base-relative	---ch_025	EQU	<[bp+6]>
...
buffer_031	EQU	+6	;base-relative	---buffer_031	EQU	<[bp+6]>
charcount_032	EQU	-2	;base-relative	---charcount_032	EQU	<[bp-2]>
ch_033	EQU	-4	;base-relative	---ch_033	EQU	<[bp-4]>
...
;  103:         ch := nextchar;
	...
	pha.w	;push acc
	jsr _nextchar_016	;---	call	nextchar_016
	adj #2	;pop ops/params
...
;  104:         UNTIL eof OR isletter(ch);
	...
	lda.w STATIC_LINK,B	;---	push	STATIC_LINK
	pha.w	;push acc
	jsr _isletter_024	;---	call	isletter_024
...
;  109:         charcount := 0;
	lda #0	;---	mov		ax,0
	sta.w charcount_032	;---	mov		WORD PTR charcount_032,ax
;  110: 
...
lastnumberindex_054	EQU	+6	;base-relative	---lastnumberindex_054	EQU	<[bp+6]>

_appendlinenumber_053	PROC
...
<<<<<<< HEAD
	psh.w #numbertable_008	;---	lea		ax,WORD PTR numbertable_008
						;---	push	ax
=======
	psh #numbertable_008	;---	lea		ax,WORD PTR numbertable_008
>>>>>>> 348a2a4122477f1f42705f6ef5783d3452a2f0b4
	lda.w lastnumberindex_054,B	;---	mov		ax,WORD PTR lastnumberindex_054
						;---	mov		dx,4
						;---	imul	dx
...
i_063	EQU	-2	;base-relative	---i_063	EQU	<[bp-2]>
...
;  173:     i := 1;
	lda #1	;---	mov		ax,1
	sta.w i_063	;---	mov		WORD PTR i_063,ax
...
=======
L_066:
	psh #wordtable_007	;---	lea		ax,WORD PTR wordtable_007
>>>>>>> 348a2a4122477f1f42705f6ef5783d3452a2f0b4
...
>>>>>>> 348a2a4122477f1f42705f6ef5783d3452a2f0b4
	...
	lda.w STATIC_LINK,B	;---	push	STATIC_LINK
	pha.w	;push acc
	jsr _appendlinenumber_053	;---	call	appendlinenumber_053
	adj #4	;pop ops/params
						;---	pop		bx
	sta.w (0,S)	;---	mov		WORD PTR [bx],ax
	adj #2	;--- pop TOS
...
i_081	EQU	-2	;base-relative	---i_081	EQU	<[bp-2]>
j_082	EQU	-4	;base-relative	---j_082	EQU	<[bp-4]>
temp_083	EQU	-28	;base-relative	---temp_083	EQU	<[bp-28]>
...
i_094	EQU	+6	;base-relative	---i_094	EQU	<[bp+6]>

_printnumbers_093	PROC
...
>>>>>>> 348a2a4122477f1f42705f6ef5783d3452a2f0b4
	...
	lda.w (0,S)	;---	mov		ax,WORD PTR [bx]
	adj #2	;pop ops/params
	sta.w i_094	;---	mov		WORD PTR i_094,ax
;  229:     UNTIL i = 0;
	lda.w i_094,B	;---	mov		ax,WORD PTR i_094
	pha.w	;---	push	ax
	lda #0	;---	mov		ax,0
...
i_099	EQU	-2	;base-relative	---i_099	EQU	<[bp-2]>
...
;  244:     writeln('Cross-reference');
	psh #S_100	;---	lea		ax,WORD PTR S_100
						;---	push	ax
	psh #0	;---	mov		ax,0
						;---	push	ax
	psh #15	;---	mov		ax,15
	...
	jsr _writeln	;---	call	_write_line
;  245:     writeln('---------------');
	psh #S_101	;---	lea		ax,WORD PTR S_101
						;---	push	ax
	psh #0	;---	mov		ax,0
						;---	push	ax
	psh #15	;---	mov		ax,15
...
;  247:     sortwords;
	lda.w STATIC_LINK,B	;---	push	STATIC_LINK
	pha.w	;push acc
	jsr _sortwords_080	;---	call	sortwords_080
	adj #2	;pop ops/params
...
>>>>>>> 348a2a4122477f1f42705f6ef5783d3452a2f0b4
	...
	lda.w STATIC_LINK,B	;---	push	STATIC_LINK
	pha.w	;push acc
	jsr _printnumbers_093	;---	call	printnumbers_093
	adj #4	;pop ops/params
;  251:     END;
...
;  260:     linenumber      := 1;
	...
	sta.w linenumber_011	;---	mov		WORD PTR linenumber_011,ax
;  261:     write('    1 : ');
	psh #S_105	;---	lea		ax,WORD PTR S_105
						;---	push	ax
	psh #0	;---	mov		ax,0
						;---	push	ax
	psh #8	;---	mov		ax,8
...
>>>>>>> 348a2a4122477f1f42705f6ef5783d3452a2f0b4
	...
	pha.w	;---	push	ax
	phx.w	;---	push	bp
	jsr _readword_030	;---	call	readword_030
	adj #4	;pop ops/params
...
L_109:
	phx.w	;---	push	bp
	jsr _enterword_062	;---	call	enterword_062
	adj #2	;pop ops/params
L_110:
;  267:     END;
	jmp L_106	;---	jmp		L_106
...
;  272:     writeln('*** The word table is not large enough. ***');
	psh #S_113	;---	lea		ax,WORD PTR S_113
						;---	push	ax
	psh #0	;---	mov		ax,0
						;---	push	ax
	psh #43	;---	mov		ax,43
...
;  276:     writeln('*** The number table is not large enough. ***');
	psh #S_117	;---	lea		ax,WORD PTR S_117
						;---	push	ax
	psh #0	;---	mov		ax,0
						;---	push	ax
	psh #45	;---	mov		ax,45
...
;  279:     printxref;
	phx.w	;---	push	bp
	jsr _printxref_098	;---	call	printxref_098
	adj #2	;pop ops/params
;  280:     END;
L_118:
L_114:
...
;  284:     writeln((nextwordindex - 1):5,   ' word entries.');
	...
	jsr _iwrite	;---	call	_write_integer
	adj #4	;---	add		sp,4
	psh #S_119	;---	lea		ax,WORD PTR S_119
						;---	push	ax
	psh #0	;---	mov		ax,0
						;---	push	ax
	psh #14	;---	mov		ax,14
...
;  285:     writeln((nextnumberindex - 1):5, ' line number entries.');
	...
	jsr _iwrite	;---	call	_write_integer
	adj #4	;---	add		sp,4
	psh #S_120	;---	lea		ax,WORD PTR S_120
						;---	push	ax
	psh #0	;---	mov		ax,0
						;---	push	ax
	psh #21	;---	mov		ax,21
...
wordtable_007	DB	12000 DUP(0)	;define array
numbertable_008	DB	4004 DUP(0)	;define array
nextwordindex_009	DW	0	;define integer
nextnumberindex_010	DW	0	;define integer
linenumber_011	DW	0	;define integer
wordtablefull_012	DW	0	;define integer
numbertablefull_013	DW	0	;define integer
newline_014	DW	0	;define integer
gotword_015	DW	0	;define integer
S_120	DB	" line number entries."	;string literal absolute
S_119	DB	" word entries."	;string literal absolute
S_117	DB	"*** The number table is not large enough. ***"	;string literal absolute
S_113	DB	"*** The word table is not large enough. ***"	;string literal absolute
S_105	DB	"    1 : "	;string literal absolute
S_101	DB	"---------------"	;string literal absolute
S_100	DB	"Cross-reference"	;string literal absolute
S_020	DB	" : "	;string literal absolute
