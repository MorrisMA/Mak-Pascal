...
charcount_032	EQU	<WORD PTR [bp-4]>
ch_033	EQU	<BYTE PTR [bp-6]>
...
i_081	EQU	<WORD PTR [bp-4]>
j_082	EQU	<WORD PTR [bp-8]>
temp_083	EQU	<WORD PTR [bp-36]>
...
wordtable_007	DB	14000 DUP(0)
numbertable_008	DB	8008 DUP(0)
